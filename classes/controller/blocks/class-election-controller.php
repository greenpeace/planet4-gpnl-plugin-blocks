...
if ( ! class_exists( 'GPNL_Election_Controller' ) ) {
	...
	class GPNL_Election_Controller extends Controller {
		...
		public function prepare_template( $fields, $content, $shortcode_tag ) : string {
			...
			wp_enqueue_style( 'gpnl_education_css', P4NLBKS_ASSETS_DIR . 'css/gpnl-educationcovers.css', [], '2.11.0-pre' );
			wp_enqueue_style( 'gpnl_slick_css', 'https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick-theme.min.css', [ 'slick' ], '2.11.0-pre' );
			wp_enqueue_style( 'gpnl_election_css', P4NLBKS_ASSETS_DIR . 'css/gpnl-election.css', [], '2.11.0-pre' );
