...
if ( ! class_exists( 'GPNL_Election_Controller' ) ) {
	...
	class GPNL_Election_Controller extends Controller {
		...
		public function prepare_template( $fields, $content, $shortcode_tag ): string {
			...
			wp_enqueue_style( 'gpnl_election_css', P4NLBKS_ASSETS_DIR . 'css/gpnl-election.css', [], '2.12.1' );
			wp_enqueue_style( 'gpnl_petition_css', P4NLBKS_ASSETS_DIR . 'css/gpnl-petition.css', [], '2.13.5' );
